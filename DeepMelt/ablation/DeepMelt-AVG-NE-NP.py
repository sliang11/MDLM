...
np.savetxt("./each_point/Deepmelt-new/Deepmelt_avg_train_ne_np_"+str(seed-162)+".csv",train_result_data,delimiter=",")
np.savetxt("./each_point/Deepmelt-new/Deepmelt_avg_valid_ne_np_"+str(seed-162)+".csv",valid_result_data,delimiter=",")
np.savetxt("./each_point/Deepmelt-new/Deepmelt_avg_test_ne_np_"+str(seed-162)+".csv",test_result_data,delimiter=",")
