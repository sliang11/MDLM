...
np.savetxt("./each_point/Deepmelt/Deepmelt_visoscity_avg_wiec_fuse_point_error_DR=0.05_NE_NR_"+str(seed-162)+".csv",resultn_visoscity_fuse.numpy().reshape(-1, 1),delimiter=",")
