...
np.savetxt("./each_point/Deepmelt-new/Deepmelt_attentional_train_ne_"+str(seed-162)+".csv",train_result_data,delimiter=",")
np.savetxt("./each_point/Deepmelt-new/Deepmelt_attentional_valid_ne_"+str(seed-162)+".csv",valid_result_data,delimiter=",")
np.savetxt("./each_point/Deepmelt-new/Deepmelt_attentional_test_ne_"+str(seed-162)+".csv",test_result_data,delimiter=",")
