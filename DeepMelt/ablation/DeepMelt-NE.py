...
class model(torch.nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers, nb_channels_raman, p_drop=0.5,
        ...
        """Initialization of DeepMelt-NE model
    ...
    def fuse(self, x, T):
        ...
        return torch.add(v, self.lambda5 * torch.tanh(fix_v)), torch.abs( torch.tanh(fix_v))
...
np.savetxt("./each_point/Deepmelt-new/Deepmelt_visoscity_attentional_wiec_fuse_point_error_NE_"+str(seed-162)+".csv",resultn_visoscity_fuse.numpy().reshape(-1, 1),delimiter=",")
