...
class model(torch.nn.Module):
    ...
    def __init__(self, input_size, hidden_size, num_layers, nb_channels_raman, p_drop=0.5,
        ...
        """Initialization of DeepMelt-NP  model
...
np.savetxt("./each_point/Deepmelt-new/Deepmelt_visoscity_attentional_wiec_fuse_point_error_NR_"+str(seed-162)+".csv",resultn_visoscity_fuse.numpy().reshape(-1, 1),delimiter=",")
