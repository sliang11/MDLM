...
def training(neuralmodel, ds, criterion, optimizer, save_switch=True, save_name="./temp", train_patience=50,
    ...
    while val_ex <= train_patience:
        ...
        if mode == "pretrain":
            ...
            loss =   loss_compensation +loss_compensation_error_min
        ...
        with torch.set_grad_enabled(False):
            ...
            if mode == "pretrain":
                ...
                loss_v =  + loss_compensation_v+loss_compensation_v_error_min
...
np.savetxt("./each_point/Deepmelt-new/Deepmelt_attentional_train_NP_"+str(seed-162)+".csv",train_result_data,delimiter=",")
np.savetxt("./each_point/Deepmelt-new/Deepmelt_attentional_valid_NP_"+str(seed-162)+".csv",valid_result_data,delimiter=",")
np.savetxt("./each_point/Deepmelt-new/Deepmelt_attentional_test_NP_"+str(seed-162)+".csv",test_result_data,delimiter=",")
