...
np.savetxt("./each_point/Deepmelt-new/Deepmelt_visoscity_attentional_wiec_fuse_point_error_NE_NR_"+str(seed-162)+".csv",resultn_visoscity_fuse.numpy().reshape(-1, 1),delimiter=",")
